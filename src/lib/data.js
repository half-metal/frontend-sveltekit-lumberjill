  ...
  export let settings = [
      {
        setting: "sidebarSide",
        description: "Determine where the sidebar will open at on screen",
      },
      {
        setting: "filterToolSide",
        description: "Determine where the map toolbar will open at on screen",
      },
      {
        setting: "Debug Map",
        description: "Opens a debug menu for the mapn",
      },
      {
        setting: "Map Size",
        description: "The side of the map on the screen",
      },
      {
        setting: "Theme",
        description: "Which theme is being used",
      }
